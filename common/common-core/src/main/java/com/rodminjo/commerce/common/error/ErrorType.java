...
/**
 * Abstract meaning of an error — the core's framework-free notion of "what kind of failure this is".
 *
 ...
 *
 * <p>Many domain {@link ErrorCode}s may share one type (HTTP has ~6 statuses, domains have many codes).
 */
