...
/**
 * Single place that turns exceptions into the standard {@link ErrorResponse}. Lives in
 * {@code common-infra} so every web service shares it via component scan — no per-service copy.
 *
 * <p>Only {@link DomainException} derives its status from {@link ErrorType}; framework exceptions
 * set their HTTP status directly and use {@link CommonErrorCode} purely for the response {@code code}.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDomain(DomainException ex, HttpServletRequest request) {
        ...
        log.warn("DomainException [{}] {} - {}", errorCode.code(), request.getRequestURI(), ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex,
        ...
        return build(HttpStatus.METHOD_NOT_ALLOWED, CommonErrorCode.METHOD_NOT_ALLOWED, List.of(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleUnexpected(Exception ex, HttpServletRequest request) {
        ...
        return build(HttpStatus.INTERNAL_SERVER_ERROR, CommonErrorCode.INTERNAL_ERROR, List.of(), request);
    }
